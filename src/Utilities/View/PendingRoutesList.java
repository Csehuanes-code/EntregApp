...
public class PendingRoutesList extends javax.swing.JFrame {

    private static PendingRoutesList instance;
    
    public static PendingRoutesList getInstance() {
        if(instance == null) instance = new PendingRoutesList();
        return instance;
    }
    
    public PendingRoutesList() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 110, 610, 300));
...
//            public void run() {
//                new PendingRoutesList().setVisible(true);
//            }
//        });
//    }
