...
public class CompletedRoutesFrame extends javax.swing.JFrame {

    private static CompletedRoutesFrame instance;
    
    public static CompletedRoutesFrame getInstance(){
        if(instance == null) instance = new CompletedRoutesFrame();
        return instance;
    }
    public CompletedRoutesFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 110, 610, 290));

        jLabel2.setFont(new java.awt.Font("Serif", 1, 18)); // NOI18N
        jLabel2.setText("Completed Routes");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        txtPanel.setText(CompletedRouteListControlator.SortRoutesByDays());
    }//GEN-LAST:event_jButton1ActionPerformed

//    public static void main(String args[]) {
//        java.awt.EventQueue.invokeLater(new Runnable() {
//            public void run() {
//                new CompletedRoutesFrame().setVisible(true);
//            }
//        });
//    }
